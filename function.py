...
def roll_dice(params):
    hit_success, extra_hit = roll_for_hit(params.hit_value, params.hit_modify, params.reroll_hits, params.reroll_hit1, params.combo_strike)
    wound_success = roll_for_wound(params.wound_value, params.wound_modify, params.reroll_wounds) if hit_success else False
